...
require_once plugin_dir_path( __FILE__ ) . 'includes/class-enginemail-smtp-settings-page.php';
require_once plugin_dir_path( __FILE__ ) . 'includes/class-enginemail-smtp-encryption.php';
require_once plugin_dir_path( __FILE__ ) . 'includes/class-enginemail-smtp-api-client.php';
require_once plugin_dir_path( __FILE__ ) . 'includes/class-enginemail-smtp-logging.php';
...
function enginemail_smtp_section_callback() {
	echo esc_html__( 'Configure the EngineMail REST API credentials and defaults used for transactional email.', 'enginemail-smtp' );
}
 ...
 */
function enginemail_smtp_pre_wp_mail( $preemptive_return, $args ) {
