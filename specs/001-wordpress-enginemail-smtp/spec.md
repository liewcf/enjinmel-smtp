...
### Primary User Story
As a WordPress site owner, I want to easily configure my site to send all emails through my EngineMail account so that I can have reliable email delivery for my transactional emails.
...
2. **Given** I have entered my EngineMail SMTP credentials and saved them, **When** my WordPress site sends an email (e.g., a password reset), **Then** the email should be sent through the EngineMail SMTP server.
